...
export class RoutesService {
  ...
  apiURL: string = "http://152.89.106.226:8086/api";
  imageURL: string = "http://152.89.106.226:3350/";
  
  apiRoot: string = AppConstants.app_environment == "Local" ? "http://localhost:5500/api" : this.apiURL;

 //apiRoot: string = AppConstants.app_environment == "Local" ? "http://192.168.10.38:5500/api" : this.apiURL;
